"""
	...
	This part need to consider other networks that is different from simple_router.py, advance_router.py in part1&2
...
DEFAULT_GATEWAY = 1
Valid_IP = [IPAddr('10.0.1.1'), IPAddr('10.0.1.2'), IPAddr('10.0.1.3'), IPAddr('10.0.1.4'), IPAddr('10.0.2.1'), IPAddr('10.0.2.2'), IPAddr('10.0.2.3'), IPAddr('10.0.2.4'), IPAddr('10.0.3.1'), IPAddr('10.0.3.2'), IPAddr('10.0.3.3'), IPAddr('10.0.3.4'), IPAddr('10.0.4.1'), IPAddr('10.0.4.2'), IPAddr('10.0.4.3'), IPAddr('10.0.4.4')]
...
Subnet4 = ['10.0.4.1', '10.0.4.2', '10.0.4.3', '10.0.4.4']
